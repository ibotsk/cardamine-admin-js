...
export default {
  ...
  listOfSpeciesUri: {
    ...
    exportUri: `${backendBase}/api/list-of-species?filter={"where":<%&where%>,"order":<%&order%>,"include":["accepted","basionym","replaced","nomen-novum","synonyms-taxonomic","synonyms-nomenclatoric","synonyms-invalid","synonyms-misidentification","basionym-for","nomen-novum-for","replaced-for"]}&access_token=<%accessToken%>`,
