export default {
  ...
  chromdata: {
    defaultOrder: [
      ...
      'doubtfulRecord', 'duplicateData', 'duplicateDataProb', 'erroneousRecord',
      'hasMajovsky', 'hocLoco',
      // dna
      'method', 'sizeC', 'sizeFrom', 'sizeTo', 'sizeUnits', 'chCount',
      'ploidy', 'ploidyRevised', 'plantsAnalysed', 'numberAnalyses', 'dnaNote',
      // material
      'world4', 'country', 'geographicalDistrict', 'phytogeographicalDistrict',
      'centralEuropeanMappingUnit', 'administrativeUnit', 'closestVillageTown',
      'altitude', 'exposition', 'description',
      'voucherSpecimenNo', 'materialDepositedIn',
      'collectedBy', 'collectedDate', 'identifiedBy',
      'coordinatesLat', 'coordinatesLon', 'coordinatesGeorefLat',
    ...
    columns: {
      ...
      coordinatesLat: {
        name: 'Coordinates Original Lat',
        column: 'material.coordinatesLat',
        group: 'material',
      },
      coordinatesLon: {
        name: 'Coordinates Original Lon',
        column: 'material.coordinatesLon',
        group: 'material',
      },
